-- Extends approved-artifact immutability to CHANNEL_VIDEO_PORTFOLIO.
...
-- workflow_steps_protect_final_research) were last widened in 202609060002 to
-- include CHANNEL_VIDEO_EXPERIMENT. This migration adds CHANNEL_VIDEO_PORTFOLIO
-- to the same allow-list so an approved allocation run's payload and finalized
...
begin
  if old.workflow_type in ('CHANNEL_RESEARCH','CHANNEL_STRATEGY','CHANNEL_CONTENT_INTELLIGENCE','CHANNEL_VIDEO_BRIEF','CHANNEL_VIDEO_SCRIPT','CHANNEL_VIDEO_PACKAGING','CHANNEL_VIDEO_RELEASE','CHANNEL_VIDEO_PERFORMANCE','CHANNEL_VIDEO_DIAGNOSIS','CHANNEL_VIDEO_DECISION','CHANNEL_VIDEO_EXPERIMENT','CHANNEL_VIDEO_PORTFOLIO')
