...
export function databaseError(error: { message: string }) {
  const entries: Array<[string, ProductionWorkflowErrorCode, number, string]> = [
    ...
    ["VIDEO_DECISION_LIMIT_REACHED", "VIDEO_DECISION_LIMIT_REACHED", 429, "Finish, cancel, or decide the active decision for this approved Diagnosis artifact before starting another run."],
    ["VIDEO_EXPERIMENT_LIMIT_REACHED", "VIDEO_EXPERIMENT_LIMIT_REACHED", 429, "Finish, cancel, or decide the active experiment design for this approved Decision artifact before starting another run."],
    ["VIDEO_PORTFOLIO_LIMIT_REACHED", "VIDEO_PORTFOLIO_LIMIT_REACHED", 429, "Finish, cancel, or decide the active portfolio allocation for this cycle before starting another run."],
    ["VIDEO_INTELLIGENCE_LIMIT_REACHED", "VIDEO_INTELLIGENCE_LIMIT_REACHED", 429, "Finish, cancel, or decide the active channel learning record for this horizon before starting another run."],
    ...
    ["UPSTREAM_DIAGNOSIS_", "UPSTREAM_DIAGNOSIS_INVALID", 409, "The exact Diagnosis run is not completed, approved, immutable, latest, and integrity-valid for Decision."],
    ["UPSTREAM_DECISION_", "UPSTREAM_DECISION_INVALID", 409, "The exact Decision run is not completed, approved, immutable, latest, experiment-eligible, and integrity-valid for an experiment."],
    ["UPSTREAM_EXPERIMENT_", "UPSTREAM_EXPERIMENT_INVALID", 409, "An exact Experiment run is not completed, approved, immutable, latest, portfolio-eligible, and integrity-valid for a portfolio allocation."],
    ["UPSTREAM_PORTFOLIO_", "UPSTREAM_PORTFOLIO_INVALID", 409, "An exact Portfolio run is not completed, approved, immutable, latest, intelligence-eligible, strategy-anchored, and integrity-valid for a channel learning record."],
