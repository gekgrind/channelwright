...
export class ResearchBudgetError extends Error {
  readonly code: "RESEARCH_RESOURCE_BUDGET_EXHAUSTED" | "STRATEGY_RESOURCE_BUDGET_EXHAUSTED" | "CONTENT_RESOURCE_BUDGET_EXHAUSTED" | "VIDEO_BRIEF_RESOURCE_BUDGET_EXHAUSTED" | "VIDEO_SCRIPT_RESOURCE_BUDGET_EXHAUSTED" | "VIDEO_PACKAGING_RESOURCE_BUDGET_EXHAUSTED" | "VIDEO_RELEASE_RESOURCE_BUDGET_EXHAUSTED" | "VIDEO_PERFORMANCE_RESOURCE_BUDGET_EXHAUSTED" | "VIDEO_DIAGNOSIS_RESOURCE_BUDGET_EXHAUSTED" | "VIDEO_DECISION_RESOURCE_BUDGET_EXHAUSTED" | "VIDEO_EXPERIMENT_RESOURCE_BUDGET_EXHAUSTED" | "VIDEO_PORTFOLIO_RESOURCE_BUDGET_EXHAUSTED" | "VIDEO_INTELLIGENCE_RESOURCE_BUDGET_EXHAUSTED";
              ...
              : workflowType === "CHANNEL_VIDEO_RELEASE" ? "VIDEO_RELEASE_RESOURCE_BUDGET_EXHAUSTED"
                : workflowType === "CHANNEL_VIDEO_PERFORMANCE" ? "VIDEO_PERFORMANCE_RESOURCE_BUDGET_EXHAUSTED"
                  : workflowType === "CHANNEL_VIDEO_DIAGNOSIS" ? "VIDEO_DIAGNOSIS_RESOURCE_BUDGET_EXHAUSTED"
                    : workflowType === "CHANNEL_VIDEO_DECISION" ? "VIDEO_DECISION_RESOURCE_BUDGET_EXHAUSTED"
                    : workflowType === "CHANNEL_VIDEO_EXPERIMENT" ? "VIDEO_EXPERIMENT_RESOURCE_BUDGET_EXHAUSTED"
                    : workflowType === "CHANNEL_VIDEO_PORTFOLIO" ? "VIDEO_PORTFOLIO_RESOURCE_BUDGET_EXHAUSTED"
                    : workflowType === "CHANNEL_VIDEO_INTELLIGENCE" ? "VIDEO_INTELLIGENCE_RESOURCE_BUDGET_EXHAUSTED"
