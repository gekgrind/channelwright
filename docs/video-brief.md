...
**Not verified in this slice:** live OpenAI or Anthropic execution for this workflow, remote migration application, live Supabase RLS behaviour, and browser review against persisted production state. `202608150001_video_brief.sql` has not been applied to any database.
